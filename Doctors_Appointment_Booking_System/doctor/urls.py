...
urlpatterns = [
    ...
    path("comment/new/", views.add_comment_view.as_view(), name="create"),
    path("comment/<int:pk>/edit/", views.edit_comment_view.as_view(), name="update"),
    path("comment/<int:pk>/delete/", views.delete_comment_view.as_view(), name="delete"),
    path("clinics/", views.ClinicListView.as_view(), name="clinics_list"),
    ...
    # path("clinics/ratings/", views.clinic_rating_summary_view.as_view(), name="clinic_rating_summary"),
]
